package com.ykuee.datamaintenance.common.mybatisplus.sqlwrapper;
...
import com.ykuee.datamaintenance.common.mybatisplus.typehandler.BaseLikeTypeHandler;
...
public class LbuWrapper<T> extends AbstractLambdaWrapper<T, LbuWrapper<T>>
	 ...
	 */
	LbuWrapper(T entity, List<String> sqlSet, AtomicInteger paramNameSeq, Map<String, Object> paramNameValuePairs,
			MergeSegments mergeSegments, SharedString lastSql, SharedString sqlComment) {
		super.setEntity(entity);
		this.sqlSet = sqlSet;
	...
	protected LbuWrapper<T> instance() {
		return new LbuWrapper<>(getEntity(), sqlSet, paramNameSeq, paramNameValuePairs, new MergeSegments(),
