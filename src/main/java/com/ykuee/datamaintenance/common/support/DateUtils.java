...
public class DateUtils extends org.apache.commons.lang.time.DateUtils{
    ...
    public final static String DEFAULT_DATE_MILLITIME_FORMAT = "yyyy-MM-dd HH:mm:ss.SSS";
...
//--格式化日期start-----------------------------------------
	...
	public static String formatByDateTimePattern(Date date) {
		 return DateFormatUtils.format(date, DEFAULT_DATE_MILLITIME_FORMAT);
	}
